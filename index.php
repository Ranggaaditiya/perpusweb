...
<html lang="en">
  <head>
    ...
    <title>PERPUS SMAN 2 CIKSEL</title>
    <link rel="icon" href="assets/logoUrl.jpeg" type="image/jpeg">
  </head>
  <body>
    <!--Navbar-->
  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary"> PERPUSTAKAAN SMAN 2 CIKARANG SELATAN</span></h2>
          <p class="mb-4">"Bangsa yang besar adalah bangsa yang gemar membaca" <br> Perpustakaan Online <span class="fw-bold">SMAN 2 CIKARANG SELATAN</span> Membawa Anda ke Dunia Buku Digital."</p>
          <a class="btn btn-primary" href="sign/link_login.html">Get started</a>
        </div>
        <div class="col mt-3">
          <img src="assets/logoDashboard-transformed.jpeg" width="300px">
        </div>
      </div>
    </section>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Rangga Aditiya</div>
        <div class="card-body">
          <h5 class="card-title">University Pelita Bangsa</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">Jalan Utama Jl. Raya Perum Bumi Cikarang Makmur, Sukadami, Cikarang Sel., Kabupaten Bekasi, Jawa Barat 17530</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Rangga Aditiya</a>  2024</p>
        </div>
      </div>
    </footer>
